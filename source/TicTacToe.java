...
public class TicTacToe extends JFrame implements ActionListener{
    ...
    public TicTacToe(){
        ...
        title.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,20));
        add(title);
        ...
        pl1.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,20));
        add(pl1);
        
        name1 = new JTextArea();
        name1.setSize(190,50);
        name1.setLocation(200,50);
        name1.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,20));
        add(name1);
        ...
        pl2.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,20));
        add(pl2);
        
        name2 = new JTextArea();
        name2.setSize(190,50);
        name2.setLocation(200,130);
        name2.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,20));
        add(name2);
        ...
        start.setFont(new Font(Font.SANS_SERIF,Font.BOLD|Font.ITALIC,15));

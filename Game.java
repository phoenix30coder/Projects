...
public class Game extends JFrame implements ActionListener{
    ...
    private void start(){
        ...
        status.setFont(new Font("vedana",Font.ITALIC,20));
        ...
        for(int i=0;i<9;i++){
            ...
            buttons[i].setFont(new Font("vedana",Font.ITALIC,20));
        ...
        playername1.setFont(new Font("vedana",Font.ITALIC,25));
        playername1.setBorder(line);
        
        score1 = new JLabel();
        score1.setText("0");
        score1.setHorizontalAlignment(JLabel.CENTER);
        score1.setFont(new Font("vedana",Font.ITALIC,40));
        score1.setBorder(line);      
        
        playername2 = new JLabel(name2);
        playername2.setHorizontalAlignment(JLabel.CENTER);
        playername2.setFont(new Font("vedana",Font.ITALIC,20));
        playername2.setBorder(line);
        
        score2= new JLabel("0");
        score2.setHorizontalAlignment(JLabel.CENTER);
        score2.setFont(new Font("vedana",Font.ITALIC,40));
        score2.setBorder(line);
            ...
            if(e.getSource() == buttons[i]){
                if(player1){
                    if(buttons[i].getText() == ""){
                        ...
                        buttons[i].setText("X");
                        buttons[i].setFont(new Font("vedana",Font.ITALIC,40));
                        player1 = false;
